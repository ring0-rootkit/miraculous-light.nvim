...
function M.setup()
	...
	hi("SpellCap", { sp = sakura, undercurl = true })
	...
	hi("Question", { fg = sakura, bold = true })
	hi("Directory", { fg = sakura })
	...
	hi("Statement", { fg = tikki_red, bold = true })
	hi("Conditional", { fg = tikki_red, bold = true })
	hi("Repeat", { fg = tikki_red, bold = true })
	hi("Label", { fg = hot_pink })
	hi("Operator", { fg = blush })
	hi("Keyword", { fg = tikki_red, bold = true })
	...
	hi("Underlined", { fg = sakura, underline = true })
	...
	hi("@text.uri", { fg = sakura, underline = true })
	...
	hi("@float", { fg = lucky_charm })
	hi("@function", { fg = fg, bold = true })
	hi("@function.builtin", { fg = tikki_red, bold = true })
	hi("@function.macro", { fg = tikki_red })
	...
	hi("@type", { fg = fg })
	hi("@type.builtin", { fg = fg, italic = true })
	...
	---------------------------------------------------------------------------
	hi("@lsp.type.class", { fg = fg, bold = true })
	hi("@lsp.type.decorator", { fg = fg })
	hi("@lsp.type.enum", { fg = fg })
	hi("@lsp.type.enumMember", { fg = fg })
	hi("@lsp.type.function", { fg = fg, bold = true })
	hi("@lsp.type.interface", { fg = fg, italic = true })
	...
	hi("NvimTreeFolderName", { fg = sakura })
	hi("NvimTreeOpenedFolderName", { fg = sakura, bold = true })
